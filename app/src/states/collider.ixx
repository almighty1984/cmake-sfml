...
export namespace collider {
    ...
    namespace aabb {
        ...
        public:
            ...
            Object() = delete;
            Object(i32 transform_id, Rectfc rect) {
                m_transform_id = transform_id;

                /*if (transform::Set::at(m_transform_id)) {
                    m_position = transform::Set::at(m_transform_id)->position;
                }*/
                m_rect = rect;
        ...
        public:
            static std::vector<Object*>& get_objects() { return m_objects; }
            ...
            static bool erase(size_t i) {
                if (!(i < m_objects.size()) || !m_objects.at(i)) {
                    Console::log("collider::aabb::Set::erase ", i, "can't do it\n");
                    return false;
                }
            ...
            static void clear() {
                for (size_t i = 0; i < m_objects.size(); ++i) {
                    Console::log("collider::aabb::Set::clear erasing ", i, "\n");
                    erase(i);
                }
                m_unused_ids.clear();
            }
