...
namespace player {
    void Object::load_config(const std::filesystem::path& path) {
        tile::Object::load_config(path);

        m_run_collider_ids.push_back(m_aabb_ids.at(0));
        m_duck_collider_ids.push_back(m_aabb_ids.at(1));
        m_swim_collider_ids.push_back(m_aabb_ids.at(2));

        //m_melee_collider_ids.push_back(m_aabb_ids.at(3));
        //m_melee_collider_ids.push_back(m_aabb_ids.at(4));

        m_melee_left_collider_id = m_aabb_ids.at(3);
        m_melee_right_collider_id = m_aabb_ids.at(4);
            ...
            if (sounds_open != std::string::npos) {
                ...
                if (sounds_close != std::string::npos) {
                    ...
                    while (1) {
                        ...
                        } else if (sound_label == "down_thrust") {
                            m_down_thrust_sound_id = sound::Set::make(sound_path);
                        } else if (sound_label == "hit_ground") {
                            m_hit_ground_sound_id = sound::Set::make(sound_path);
                        ...
                        } else if (sound_label == "swing_attach") {
                            m_swing_attach_sound_id = sound::Set::make(sound_path);
                        } else if (sound_label == "swing_detach") {
                            m_swing_detach_sound_id = sound::Set::make(sound_path);
                        }
    ...
    void player::Object::update() {
        ...
        case State::swing: update_swing(); break; }
