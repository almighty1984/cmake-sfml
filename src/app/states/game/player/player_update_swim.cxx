...
void player::Object::update_swim() { 
    if (m_prev_state != State::swim) {
        m_prev_state = State::swim;
    ...
    if (m_next_state == player::State::run && m_time_left_in_state == 0) {
        ...
        for (auto& i : m_swim_collider_ids) aabb::Set::at(i)->is_inactive(true);
    }
}