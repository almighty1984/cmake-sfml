...
export namespace plane {
    ...
    public:
        ...
        void set_velocity(Vec2fc v) {
            for (int layer = 0; layer < m_num_layers; layer += 1) {
        ...
        void create(u8c columns, u8c rows) {
            load_config("res/planes/forest.cfg", columns, rows);
        }
                    ...
                    if (plane_close != std::string::npos) {
                        ...
                        if (texture_label < plane_close) {
                            ...
                            if (texture_start < end_line) {
                                ...
                                texture_path = "res/textures/" + text.substr(texture_start, end_line - texture_start);
        ...
        void update() {
            ...
            //Console::log("plane ", m_transform_ids.front(), " position ", transform::Set::at(m_transform_ids.front())->position.x, " ", transform::Set::at(m_transform_ids.front())->position.y, "\n");

            //Console::log("plane layers: ", (int)m_num_layers, " stride: ", m_id_stride, "\n");
            for (int i = 0; i < m_num_layers; i += 1) {
