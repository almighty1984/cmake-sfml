...
export namespace player {    
    ...
    public:
        ...
        void collide_melee_x(aabb::Infoc our, aabb::Infoc other);
        void collide_melee_y(aabb::Infoc our, aabb::Infoc other);

        void collide_interact_x(aabb::Infoc our, aabb::Infoc other);
        void collide_interact_y(aabb::Infoc our, aabb::Infoc other);
        ...
        bool is_all_valid() override {
            return anim::Set::is_valid(m_crawl_anim_id)          &&
                   ...
                   anim::Set::is_valid(m_lever_anim_id)          &&
                   anim::Set::is_valid(m_melee_anim_id)          &&
        ...
        void set_layer(u8c layer) { if (sprite::Set::at(m_sprite_id)) sprite::Set::at(m_sprite_id)->layer = layer; }
